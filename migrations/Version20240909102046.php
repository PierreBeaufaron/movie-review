 ...
 */
final class Version20240909102046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE director CHANGE birth_date birth_date DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE director CHANGE birth_date birth_date DATE DEFAULT NULL');
    }
}
